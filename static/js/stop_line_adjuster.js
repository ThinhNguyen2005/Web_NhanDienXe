...
class RoiAdjuster {
    ...
    setupEventListeners() {
        ...
        // Nút vẽ vùng chờ
        document.getElementById('btnDrawWaitingZone').addEventListener('click', () => {
        ...
        // Nút vẽ vùng vi phạm
        document.getElementById('btnDrawViolationZone').addEventListener('click', () => {
            this.isDrawingWaiting = false;
...
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('videoCanvas') && document.getElementById('videoSource')) {
        window.stopLineAdjuster = new StopLineAdjuster('videoCanvas', 'videoSource');
    }
});